         ...
         */
        template <class HashedObj>
        void QuadraticHashTable<HashedObj>::insert( int key, const HashedObj & x )
        {
                // Insert x as active
            int currentPos = findPos( key );
            // if( isActive( currentPos ) )
            //     return;
            array[ currentPos ] = HashEntry( x, ACTIVE, key );
         ...
         */
        template <class HashedObj>
        int QuadraticHashTable<HashedObj>::findPos(int key) const
        {
...
/* 7*/      return currentPos;
         ...
         */
        template <class HashedObj>
        void QuadraticHashTable<HashedObj>::remove( int key )
        {
            int currentPos = findPos( key );
            if( isActive( currentPos ) )
         ...
         */
        template <class HashedObj>
        const HashedObj & QuadraticHashTable<HashedObj>::find( int key ) const
        {
            int currentPos = findPos( key );
